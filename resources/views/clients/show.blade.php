...
@section('content')
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start mb-6 border-b pb-4">
                <div>
                    ...
                    <p class="text-gray-500">Informations complètes sur le client <span class="font-mono font-semibold text-blue-600">{{ $client->code_client }}</span></p>
                </div>
                <a href="{{ route('clients.index') }}" class="mt-4 sm:mt-0 text-blue-500 hover:text-blue-700 font-semibold flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="md:col-span-2"><h3 class="text-lg font-semibold text-gray-700 border-b pb-2 mb-4">Informations Personnelles</h3></div>

                <div>
                    <p class="text-sm font-medium text-gray-500">Nom Complet</p>
                    <p class="text-lg font-semibold text-gray-800">{{ $client->nom_client }} {{ $client->prenom_client }}</p>
                </div>
                <div>
                ...
                <div class="md:col-span-2 mt-6"><h3 class="text-lg font-semibold text-gray-700 border-b pb-2 mb-4">Informations de Gestion</h3></div>
        ...
        {{-- Hna men be3d nqdrou nzido la liste dyal les factures dyal had l'client --}}
